	...
	public function addCustomer($data) {
      	...
      	if (isset($data['address'])) {		
      		foreach ($data['address'] as $address) {	
      			$this->db->query("INSERT INTO " . DB_PREFIX . "address SET  mobile = '" .  $this->db->escape($address['mobile']) . "', phone = '" .  $this->db->escape($address['phone']) . "', customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($address['firstname']) . "',  address_1 = '" . $this->db->escape($address['address_1']) . "', address_2 = '" . $this->db->escape($address['address_2']) . "', city = '" . $this->db->escape($address['city']) . "', postcode = '" . $this->db->escape($address['postcode']) . "', country_id = '" . (int)$this->config->get('config_country_id') . "', zone_id = '" . (int)$address['zone_id'] . "'");
      	...
      	if (isset($data['address'])) {
      		foreach ($data['address'] as $address) {
				...
				if ($address['address_id']) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "address SET  mobile = '" .  $this->db->escape($address['mobile']) . "', phone = '" .  $this->db->escape($address['phone']) . "', address_id = '" . $this->db->escape($address['address_id']) . "', customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($address['firstname']) . "',  address_1 = '" . $this->db->escape($address['address_1']) . "', address_2 = '" . $this->db->escape($address['address_2']) . "', city_id = '" . (int)$address['city_id'] . "', postcode = '" . $this->db->escape($address['postcode']) . "', country_id = '" . (int)$address['country_id'] . "', zone_id = '" . (int)$address['zone_id'] . "'");
					
					if (isset($address['default'])) {
						$this->db->query("UPDATE " . DB_PREFIX . "customer SET address_id = '" . (int)$address['address_id'] . "' WHERE customer_id = '" . (int)$customer_id . "'");
					}
				} else {
					$this->db->query("INSERT INTO " . DB_PREFIX . "address SET   mobile = '" .  $this->db->escape($address['mobile']) . "', phone = '" .  $this->db->escape($address['phone']) . "',customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($address['firstname']) . "', address_1 = '" . $this->db->escape($address['address_1']) . "', address_2 = '" . $this->db->escape($address['address_2']) . "', city_id = '" . (int)$address['city_id'] . "', postcode = '" . $this->db->escape($address['postcode']) . "', country_id = '" . (int)$address['country_id'] . "', zone_id = '" . (int)$address['zone_id'] . "'");
