...
<div style="width:649px;height:978px;page-break-after: always;margin:0 auto;border:1px #ddd solid;padding:5px;margin-bottom:5px;">
  ...
  <table class="store">
   ...
   <table class="address">
    ...
    <tr>
        <td><b><?php echo $text_payment_method; ?></b> <?php echo $order['payment_method']; ?></td>
  		<td><b><?php echo $text_shipping_method; ?></b> <?php echo $order['shipping_method']; ?></td>
    </tr>
    <tr>
        <td><b><?php echo $text_express; ?>:</b> <?php echo $order['express']; ?></td>
  		<td><b><?php echo $text_express_no; ?>:</b> <?php echo $order['express_no']; ?></td>
    </tr>
   </table>
