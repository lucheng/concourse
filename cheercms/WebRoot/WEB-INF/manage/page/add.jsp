...
<html>
	...
	<body class="input">
		...
		<div class="body">
			<form id="validateForm" action="article_category!save.action" method="post">
				...
				<table class="inputTable">
					<tbody><tr>
						...
						<td>
							<input type="text" id="articleCategoryName" name="articleCategory.name" class="formText" value="">
