...
<head>
	...
	<body class="list">
		...
		<div class="body articleCategory">
			<form id="listForm" action="productCategory/list" method="post">
				<div class="listBar">
					<input type="button" class="formButton" onclick="location.href='productCategory/add'" value="添加分类" hidefocus="">
				</div>
						...
						<tr grade="0">
							...
							<td>
								<a href="/shop/article_list/about_us.htm" target="_blank" title="浏览">[浏览]</a>
									<a href="productCategory/delete/${entry.id}" class="deleteArticleCategory" title="删除">[删除]</a>
								<a href="productCategory/edit/${entry.id}" title="编辑">[编辑]</a>
							</td>
						</tr>
								...
								<tr grade="1">
									...
									<td>
										<a href="/shop/article_list/terms.htm" target="_blank" title="浏览">[浏览]</a>
											<a href="productCategory/delete/${child.id}" class="deleteArticleCategory" title="删除">[删除]</a>
										<a href="productCategory/edit/${child.id}" title="编辑">[编辑]</a>
									</td>
								</tr>
							</c:forEach>
						</c:forEach>	
