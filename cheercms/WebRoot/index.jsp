...
<html>
	<head>
		...
		<script type="text/javascript" src="home/js/jquery.tools.js"></script>
		<script type="text/javascript" src="home/js/index.js"></script>
		<script type="text/javascript" src="home/js/header.js"></script>
		<script type="text/javascript" src="home/js/friend_link.js"></script>
	</head>
	<body class="index">
	...
	<div class="header">
		<div class="headerTop">
			<div class="headerLogo">
				<a href="/"><img src="home/images/logo.gif" title="SHOP++官方网站 - 网店系统|商城系统|独立网店|购物系统|开店程序|电子商务系统|网上开店|网上购物系统|网上商城系统"></a>
			</div>
		...
		<div class="headerNavigation belatedPNG">
					...
					<div id="sliderScrollable" class="scrollable">
						<div class="items" style="left: -2136px; "><div class="cloned">
								<a href="/html/article_content/201011/alipay.html">
									<img src="home/images/banner3.jpg" alt="SHOP++携手支付通，共同打造在线支付便捷通道"> 							</a>
							</div>
							<div>
							        <a href="/html/article_content/201105/d039bfd015344c4c809177390478a6b7.html">
									<img src="home/images/banner_2011_5_23.jpg">
								</a>
							</div>
							<div>
								<a href="/html/article_content/201012/tenpay.html">
									<img src="home/images/banner2.jpg" alt="SHOP++携手财付通，打造优质支付通道"> 							</a>
							</div>
							<div>
								<a href="/html/article_content/201011/alipay.html">
									<img src="home/images/banner3.jpg" alt="SHOP++携手支付通，共同打造在线支付便捷通道"> 							</a>
			...
			<div class="blank"></div>
	<link href="home/css/friend_link.css" type="text/css" rel="stylesheet">
	<div class="friendLink">
		...
		<div class="blank"></div>
	<link href="home/css/footer.css" type="text/css" rel="stylesheet">
	<div class="footer">
	...
	document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F96cff931eaf40ae9073c5935cb9ae3b3' type='text/javascript'%3E%3C/script%3E"));
			...
			<p>
				<a href="http://www.51honest.org/fiveIndex.credit?action=preLevel&amp;creditCode=9992324110143099" target="_blank">
					<img src="home/images/51honest.gif" alt="国家商务部授权预评级">
				</a>
				<a href="http://open.soft.360.cn/zhengshu.htm?id=140281" target="_blank">
					<img src="home/images/360.gif" alt="360软件安全认证">
				</a>
				<a href="http://union.rising.com.cn/InfoManage/attestation.aspx?p0=N2PmKkcKwdKdHNynIYMiCzO1ARPSeGLH" target="_blank">
					<img src="home/images/rising.gif" alt="瑞星云安全网站联盟认证">
				</a>
				<a href="http://net.china.com.cn" target="_blank">
					<img src="home/images/china.gif" alt="中国互联网违法和不良信息举报中心">
				</a>
			</p>
		</div>
	</div>
	<%--<script type="text/javascript" src="http://static.b.qq.com/account/bizqq/js/wpa.js?type=13&amp;kfuin=4000007477&amp;ws=www.shopxx.net&amp;title=&amp;cot1=%E5%91%A8%E4%B8%80%20%E8%87%B3%20%E5%91%A8%E5%85%AD%0A08%3A30%20-%2017%3A30&amp;btn1=%E7%AB%8B%E5%88%BB%E5%92%A8%E8%AF%A2&amp;fsty=0&amp;fposX=2&amp;fposY=1&amp;tx=2&amp;aty=0&amp;a=" tag="isInit"></script>
	--%><div style="z-index: 88888888; left: auto; right: 8px; margin-left: 0px; bottom: auto; position: absolute; margin-top: 0px; display: block; top: 177.5px; ">
	<%--<div id="__WPA_CLOSEBTN__" style="display: block; width: 39px; height: 18px; position: absolute; top: 6px; right: 10px; cursor: pointer; "></div>
	--%></div>
	</body>
</html>