...
public class SettingUtil {
	...
	public static Setting readSetting() throws URISyntaxException, DocumentException, IOException {
		...
		Node upyunUrlNode = document.selectSingleNode("/shopxx/setting/upyunUrl");
		...
		setting.setUpyunUrl(upyunUrlNode.getText());
	...
	public static void writeSetting(Setting setting) {
		...
		if(upyunUrlNode == null){
			upyunUrlNode = settingElement.addElement("upyunUrl");
		}
		...
		upyunUrlNode.setText(setting.getUpyunUrl());
