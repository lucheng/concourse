...
<title>添加/编辑商品 - Powered By CHEERFLY</title>
				...
				<#list (goods.goodsImageList)! as goodsImage>
					<tr class="goodsImageTr">
						<td>
							...
							<a href="${setting.upyunUrl}${goodsImage.thumbnailImagePath}" title="点击查看" target="_blank">
								<img src="${setting.upyunUrl}${goodsImage.thumbnailImagePath}" style="width: 50px; height: 50px;" />
							</a>
						</td>
						<td>
