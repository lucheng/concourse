...
<title>${goods.name}<#if setting.isShowPoweredInfo> - Powered By CHEERFLY</#if></title>
					...
					<div class="goodsImage">
						<#if goods.goodsImageList??>
		                	<#list goods.goodsImageList as goodsImage>
		                		<a href="${setting.upyunUrl}${goodsImage.bigImagePath}" class="tabContent zoom<#if (goodsImage_index > 0)> nonFirst</#if>">
									<img src="${setting.upyunUrl}${goodsImage.smallImagePath}" alt="点击放大" />
								</a>
							</#list>
						<#else>
	            			<a href="${setting.upyunUrl}${setting.defaultBigGoodsImagePath}" class="zoom">
								<img src="${setting.upyunUrl}${setting.defaultSmallGoodsImagePath}" alt="点击放大" />
							</a>
	                	</#if>
                	</div>
					<div class="thumbnailGoodsImage">
						...
						<div id="thumbnailGoodsImageScrollable" class="scrollable">
							<ul id="goodsImageTab" class="items goodsImageTab">
								<#if goods.goodsImageList??>
									<#list goods.goodsImageList as goodsImage>
										<li><img src="${setting.upyunUrl}${goodsImage.thumbnailImagePath}" alt="${goodsImage.description}" /></li>
									</#list>
								<#else>
