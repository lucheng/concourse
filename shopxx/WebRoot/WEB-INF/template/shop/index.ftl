...
<title>${(setting.shopName)!}<#if setting.isShowPoweredInfo> - Powered By CHEERFLY</#if></title>
<meta name="Author" content="CHEERFLY Team" />
<meta name="Copyright" content="CHEERFLY" />
...
if(Request['p']!= null){
	window.location.href = 'http://blog.cheerfly.com/?p='+Request['p'];//获取该地址并 跳转
}
if(Request['tag']!= null){
	window.location.href = 'http://blog.cheerfly.com/?tag='+Request['tag'];//获取该地址并 跳转
}
if(Request['cat']!= null){
	window.location.href = 'http://blog.cheerfly.com/?cat='+Request['cat'];//获取该地址并 跳转
}
</Script>
...
<body class="index">
	...
	<div class="body">
		...
		<div class="bodyRight">
			<div class="slider">
				<div id="sliderScrollable" class="scrollable">
					<div class="items">
						<div>
							<img src="http://images.cheerfly.com/upload/image/banner/banner1.jpg" />
						</div>
						<div>
							<img src="http://images.cheerfly.com/upload/image/banner/banner2.jpg" />
						</div>
						<div>
							<img src="http://images.cheerfly.com/upload/image/banner/banner3.jpg" />
						</div>
					</div>
					<div class="navi"></div>
					<div class="prevNext">
								...
								<#list goodsList as goods>
									...
									<li>
										<a href="${base}${goods.htmlPath}">
											<img src="${setting.upyunUrl}${goods.defaultThumbnailGoodsImagePath}" alt="${goods.name}" />
		...
		-->
		<script type="text/javascript">
		alimama_pid="mm_18381334_2824217_11012773";
		alimama_width=1000;
		alimama_height=100;
		</script>
