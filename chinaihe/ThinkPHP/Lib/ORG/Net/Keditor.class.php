...
class Keditor extends Think{
	public $jspath="__ROOT__/Public/editor/kindeditor.js";
	...
	public static  function upload($save_path = '__ROOT__/Public/Upload/',$save_url = '__ROOT__/Public/Upload/',$ext_arr = array('gif', 'jpg', 'jpeg', 'png', 'bmp'),$max_size = 1000000){
		import("ORG.Net.JSON");
		//有上传文件时
		function alert($msg) {
...
public static function filemanager($root_path="__ROOT__/Public/Upload/",$root_url="__ROOT__/Public/Upload/",$ext_arr=array('gif', 'jpg', 'jpeg', 'png', 'bmp')){
import("ORG.Net.JSON");
if (empty($_GET['path'])) {
