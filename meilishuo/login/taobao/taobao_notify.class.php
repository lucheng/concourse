...
class TaobaoNotify {
    ...
    function TaobaoNotify($taobao_config) {
	...
	function getMysign($para_temp) {
		...
		//生成签名结果
		$mysign = buildMysign($para_sort, trim($this->taobao_config['key']), strtoupper(trim($this->taobao_config['sign_type'])));
	...
	function getResponse($notify_id) {
		$transport = strtolower(trim($this->taobao_config['transport']));
		$partner = trim($this->taobao_config['partner']);
		$veryfy_url = '';
		if($transport == 'https') {
