...
0
|| checkTplRefresh('./tpl/uu43/page/shop.htm', './tpl/uu43/inc/header.htm', 1330265340, './data/tpl/compiled/page_shop.tpl.php', './tpl/uu43', 'page/shop')
|| checkTplRefresh('./tpl/uu43/page/shop.htm', './tpl/uu43/inc/pages.htm', 1330265340, './data/tpl/compiled/page_shop.tpl.php', './tpl/uu43', 'page/shop')
|| checkTplRefresh('./tpl/uu43/page/shop.htm', './tpl/uu43/inc/footer.htm', 1330265340, './data/tpl/compiled/page_shop.tpl.php', './tpl/uu43', 'page/shop')
;?>
<?php 
...
<div class="daren_tag">
<a<? if($is_best) { ?> class="c"<? } ?> href="<?php echo FU('shop/index',array()); ?>">热荐格子铺</a>/ <a<? if($is_all) { ?> class="c"<? } ?> href="<?php echo FU('shop/all',array()); ?>" >所有格子铺</a></div>
</div>
