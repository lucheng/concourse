...
<div class="new_event"> <span class="title"></span><a href="<?php echo FU('club/forum',array("fid"=>"42")); ?>" target="_blank" class="more">更多...</a>
...
<div class="f_i_img">
<a href="<?=$topic['url']?>" target="_blank"><img src="<?php echo getImgName($topic['imgs'][0]['img'],90,70); ?>" class="r10"/></a>
</div>
</div>
<ul class="f_i_ll">
<? } else { ?>
