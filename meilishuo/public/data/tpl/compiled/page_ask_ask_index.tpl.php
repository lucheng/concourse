...
<a href="<?=$ask_thread['url']?>"><img width="48" height="48" src="<?php echo getImgName($ask_thread['imgs'][0]['img'],80,80); ?>" class="avatar_img r5"/></a>
<div class="medal_text">
<a href="<?=$ask_thread['url']?>" target="_blank" class="gc"><?php echo cutStr($ask_thread['title'],20,'...');?></a>
<div>
<?=$ask_thread['time']?><br>
<a target="_blank" href="<?=$ask_thread['user']['url']?>"><span><?=$ask_thread['user']['user_name']?></span></a>
</div>
</div>
</li>
<? } } ?>
