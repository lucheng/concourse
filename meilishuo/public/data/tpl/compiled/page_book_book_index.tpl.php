...
<div class="imagewall" id="imagewall_container"><?php $col_index = 0; if(is_array($share_display)) { foreach($share_display as $share_col) { ?><?php $col_index++; ?><div class="col<?=$col_index?> clear_in share_col"><? if(is_array($share_col)) { foreach($share_col as $share) { ?><div class="i_w_f" id="share_item_<?=$share['share_id']?>">
<div class="hd"></div>
<div class="bd">
...
<a target="_blank" href="<?=$share['url']?>" class="creply"><?=$share['comment_count']?>评论</a>
</div>
</div>
<div class="who_share">
<div class="ws_bd">
<a href="<?=$share['user']['url']?>" target="_blank"><img alt="<?=$share['user']['user_name']?>" class="icard avt fl" src="<?php echo avatar($share['uid'],'s',1);?>" width="24" height="24"></a>
<p>
由<a target="_blank" href="<?=$share['user']['url']?>" class="n icard "> <?=$share['user']['user_name']?></a> <span style="font-weight:bold;color:#e8876d;">分享</span><br>
<span class="t"><?=$share['time']?></span>
</p>
</div>
<div class="tk clearfix">
<p><?php echo cutStr($share['content'],200,'...');?></p>
</div>
<div class="ws_ft"></div>
</div>
</div>
...
{
$(this).append(rowHtml);
$('.empty_row .bd',this).height(colHeight - $(this).height() - 20);
}
});
};
