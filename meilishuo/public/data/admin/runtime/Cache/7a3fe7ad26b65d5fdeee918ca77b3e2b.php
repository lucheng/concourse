...
<script type="text/javascript" src="__TMPL__Static/Js/shop.js"></script>
<script type="text/javascript">
var CONFIRM_ERROR = "<?php echo L("CONFIRM_ERROR");?>";
var NAME_EMPTY_TIP = "<?php echo L("NAME_EMPTY_TIP");?>";
var URL_EMPTY_TIP	=	"<?php echo L("URL_EMPTY_TIP");?>";
</script>
...
<table cellpadding="4" cellspacing="0" border="0" class="table-form">
	<tr>
		<th width="150"><?php echo L("SHOP_NAME");?></th>
		<td><input type="text" class="textinput" name="shop_name" id="shop_name" value="" style="width:400px;" /></td>
	</tr>
	<tr>
		<th><?php echo L("SHOP_URL");?></th>
		<td>
			<input type="text" class="textinput" name="shop_url" id="shop_url" value=""  style="width:400px;" />
		</td>
	</tr>
	<tr>
		<th><?php echo L("SHOP_LOGO");?></th>
		<td>
			<input type="file" class="fileinput" name="shop_logo" size="30" />
		</td>
	</tr>
	<tr>
		<th><?php echo L("SHOP_CATEGORY");?></th>
		<td>
			<select name="cate_id">
				<option value="0"><?php echo L("NO_CATE");?></option>
				<?php if(is_array($cate_tree)): foreach($cate_tree as $key=>$cate_item): ?><option value="<?php echo ($cate_item["cate_id"]); ?>"><?php echo ($cate_item["title_show"]); ?></option><?php endforeach; endif; ?>
			</select>
		</td>
	</tr>
