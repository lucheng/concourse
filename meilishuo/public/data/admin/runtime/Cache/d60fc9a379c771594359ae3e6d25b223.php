...
<table cellpadding="4" cellspacing="0" border="0" class="table-form">
	<tr>
		<th width="180"><?php echo L("TAG_NAME");?></th>
		<td><input type="text" class="textinput requireinput" name="tag_name" /></td>
	</tr>
	<tr>
		<th><?php echo L("IS_HOT");?></th>
		<td>
			<label><input type="radio" name="is_hot" value="1" checked="checked" /><span><?php echo L("YES");?></span></label>
			<label><input type="radio" name="is_hot" value="0"/><span><?php echo L("NO");?></span></label>
		</td>
	</tr>
	<tr>
