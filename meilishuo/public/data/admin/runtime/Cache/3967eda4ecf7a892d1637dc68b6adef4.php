...
<div class="handle-btns">
	...
	<div class="img-button "><p><input type="button" id="editData" name="editData" value="<?php echo L("EDIT");?>" onclick="editData(this,'checkList','aid')" class="editData"></p></div>
...
<!-- Think 系统列表组件开始 -->
<table id="checkList" class="table-list list" cellpadding="0" cellspacing="0" border="0"><thead><tr><th width="30" class="first"><input type="checkbox" onclick="checkAll('checkList')"></th><th width="50" ><a href="javascript:sortBy('aid','<?php echo ($sort); ?>','index')" title="按照<?php echo L("ID");?><?php echo ($sortType); ?> "><?php echo L("ID");?><?php if(($order)  ==  "aid"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="~left" ><a href="javascript:sortBy('name','<?php echo ($sort); ?>','index')" title="按照<?php echo L("ASK_NAME");?><?php echo ($sortType); ?> "><?php echo L("ASK_NAME");?><?php if(($order)  ==  "name"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="50" ><a href="javascript:sortBy('status','<?php echo ($sort); ?>','index')" title="按照<?php echo L("STATUS");?><?php echo ($sortType); ?> "><?php echo L("STATUS");?><?php if(($order)  ==  "status"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="100" ><a href="javascript:sortBy('thread_count','<?php echo ($sort); ?>','index')" title="按照<?php echo L("THREAD_COUNT");?><?php echo ($sortType); ?> "><?php echo L("THREAD_COUNT");?><?php if(($order)  ==  "thread_count"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="100" ><a href="javascript:sortBy('sort','<?php echo ($sort); ?>','index')" title="按照<?php echo L("SORT");?><?php echo ($sortType); ?> "><?php echo L("SORT");?><?php if(($order)  ==  "sort"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="80">操作</th></tr></thead><tbody><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ask): ++$i;$mod = ($i % 2 )?><tr class="<?php if(($mod)  ==  "0"): ?>even<?php endif; ?>"><td class="first"><input type="checkbox" name="key"	value="<?php echo ($ask["aid"]); ?>"></td><td ><?php echo ($ask["aid"]); ?></td><td align="left" ><?php echo ($ask["name"]); ?></td><td ><span class="pointer" module="Ask" href="javascript:;" onclick="toggleStatus(this,'<?php echo (addslashes($ask["aid"])); ?>','status')"><?php echo (getStatusImg($ask["status"])); ?></span></td><td ><?php echo ($ask["thread_count"]); ?></td><td ><span class="pointer" module="Ask" href="javascript:;" onclick="textEdit(this,'<?php echo (addslashes($ask["aid"])); ?>','sort')"><?php echo ($ask["sort"]); ?></span></td><td><a href="javascript:;" onclick="editData(this,'<?php echo ($ask["aid"]); ?>','aid')"><?php echo L("EDIT");?></a>&nbsp;&nbsp;<a href="javascript:;" onclick="removeData(this,'<?php echo ($ask["aid"]); ?>','aid')"><?php echo L("REMOVE");?></a>&nbsp;&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?></tbody></table>
<!-- Think 系统列表组件结束 -->
