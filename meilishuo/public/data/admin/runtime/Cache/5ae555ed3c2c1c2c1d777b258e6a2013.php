...
<div class="handle-btns">
	<div class="img-button "><p><input type="button" id="addFriendLink" name="addFriendLink" value="<?php echo L("ADD");?>" onclick="addData()" class="addFriendLink"></p></div>
	<div class="img-button "><p><input type="button" id="editFriendLink" name="editFriendLink" value="<?php echo L("EDIT");?>" onclick="editData(this,'checkList')" class="editFriendLink"></p></div>
	<div class="img-button "><p><input type="button" id="removeFriendLink" name="removeFriendLink" value="<?php echo L("REMOVE");?>" onclick="removeData(this,'checkList')" class="removeFriendLink"></p></div>
</div>
<div class="search-box">
</div>
<!-- Think 系统列表组件开始 -->
<table id="checkList" class="table-list list" cellpadding="0" cellspacing="0" border="0"><thead><tr><th width="30" class="first"><input type="checkbox" onclick="checkAll('checkList')"></th><th width="50" ><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index')" title="按照<?php echo L("ID");?><?php echo ($sortType); ?> "><?php echo L("ID");?><?php if(($order)  ==  "id"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="~left" ><a href="javascript:sortBy('name','<?php echo ($sort); ?>','index')" title="按照<?php echo L("NAME");?><?php echo ($sortType); ?> "><?php echo L("NAME");?><?php if(($order)  ==  "name"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="80" ><a href="javascript:sortBy('sort','<?php echo ($sort); ?>','index')" title="按照<?php echo L("SORT");?><?php echo ($sortType); ?> "><?php echo L("SORT");?><?php if(($order)  ==  "sort"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="60" ><a href="javascript:sortBy('status','<?php echo ($sort); ?>','index')" title="按照<?php echo L("STATUS");?><?php echo ($sortType); ?> "><?php echo L("STATUS");?><?php if(($order)  ==  "status"): ?><img src="__TMPL__Static/Images/<?php echo ($sortImg); ?>.gif" align="absmiddle"><?php endif; ?></a></th><th width="100">操作</th></tr></thead><tbody><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): ++$i;$mod = ($i % 2 )?><tr class="<?php if(($mod)  ==  "0"): ?>even<?php endif; ?>"><td class="first"><input type="checkbox" name="key"	value="<?php echo ($link["id"]); ?>"></td><td ><?php echo ($link["id"]); ?></td><td align="left" ><span class="pointer" module="FriendLink" href="javascript:;" onclick="textEdit(this,'<?php echo (addslashes($link["id"])); ?>','name')"><?php echo ($link["name"]); ?></span></td><td ><span class="pointer" module="FriendLink" href="javascript:;" onclick="numberEdit(this,'<?php echo (addslashes($link["id"])); ?>','sort')"><?php echo ($link["sort"]); ?></span></td><td ><span class="pointer" module="FriendLink" href="javascript:;" onclick="toggleStatus(this,'<?php echo (addslashes($link["id"])); ?>','status')"><?php echo (getStatusImg($link["status"])); ?></span></td><td><a href="javascript:;" onclick="editData(this,'<?php echo ($link["id"]); ?>','id')"><?php echo L("EDIT");?></a>&nbsp;&nbsp;<a href="javascript:;" onclick="removeData(this,'<?php echo ($link["id"]); ?>','id')"><?php echo L("REMOVE");?></a>&nbsp;&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?></tbody></table>
<!-- Think 系统列表组件结束 -->
