...
<script type="text/javascript" src="__TMPL__Static/Js/shopcategory.js"></script>
<script type="text/javascript">
...
<table cellpadding="4" cellspacing="0" border="0" class="table-form">
	<tr>
		<th width="150"><?php echo L("SHOPCATE_NAME");?></th>
		<td><input type="text" class="textinput" name="name" id="name" value="" style="width:400px;" /></td>
	</tr>
	<tr>
		<th><?php echo L("SHOPCATE_CODE");?></th>
		<td>
			<input type="text" class="textinput" name="code" id="code" value=""  />
		</td>
	</tr>
	<tr>
