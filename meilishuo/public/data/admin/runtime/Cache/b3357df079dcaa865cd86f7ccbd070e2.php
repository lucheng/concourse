...
<table cellpadding="4" cellspacing="0" border="0" class="table-form">
	...
	<tr>
		...
		<td><input type="text" class="textinput requireinput" name="url" value="<?php echo ($vo["url"]); ?>"/></td>
	</tr>
	<tr>
		<th><?php echo L("IMG");?></th>
		<td>
			<input type="file" class="fileinput" name="img" size="30" />
			<?php if($vo['img'] != ''): ?><a href="__ROOT__/<?php echo ($vo["img"]); ?>" target="_blank" ><?php echo L("VIEW");?></a><?php endif; ?>
		</td>
	</tr>
	<tr>
