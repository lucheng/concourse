...
class BookModule
{
	...
	{
		global $_FANWE;
		if(file_exists(FANWE_ROOT.'./public/data/tpl/caches/page/is_clear.lock')){
			@unlink(FANWE_ROOT.'./public/data/tpl/caches/page/is_clear.lock');
			define("BOOK_CACHE_PAGE_TIME",0);
		}
