...
<td colspan="5" align=left class="admintitle">文章列表　[<a href="__URL__/add">添加</a>][<a onclick="showhelp();">操作提示</a>]</td></tr>
    ...
    <td height="25">[<a href="__URL__/index/typeid/<?php echo ($vo["typeid"]); ?>"><?php echo ($vo["typename"]); ?></a>]<a href="__ROOT__/<?php echo ($urlmode); ?>articles/<?php echo ($vo["aid"]); ?><?php echo ($suffix); ?>" target="_blank"><?php echo ($vo["title"]); ?></a><?php if(($vo["ishot"])  ==  "1"): ?><font color="red">[荐]</font><?php endif; ?><?php if(($vo["istop"])  ==  "1"): ?><font color="red">[顶]</font><?php endif; ?><?php if(($vo["isimg"])  ==  "1"): ?><font color="red">[图]</font><?php endif; ?><?php if(($vo["islink"])  ==  "1"): ?><font color="red">[转]</font><?php endif; ?></td>
