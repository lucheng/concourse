...
<div id="mainbody">
 <!--<div class="left_side">
   ...
   <h1><?php echo ($titler); ?></h1>
    <div class="category">
     <ul>
     	<?php if(is_array($pages)): ?><?php $i = 0;?><?php $__LIST__ = $pages?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><li class="left_side_line"><a href="/index.php/Pages/index/module/<?php echo (is_array($vo)?$vo["module"]:$vo->module); ?>/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>.html" target=_self><?php echo (is_array($vo)?$vo["subject"]:$vo->subject); ?></a></li><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
     </ul>
    </div>
   </div>
 ...
 <div class="right-side company_info">
 <div class="root_info">
         <span><?php echo ($titler); ?></span>
  </div>
  <div class="root_info_line"></div>
    <div id="featured">
   		<div id="info" class="corner_10">
   		 <h4><?php echo (is_array($page)?$page["subject"]:$page->subject); ?></h4>
