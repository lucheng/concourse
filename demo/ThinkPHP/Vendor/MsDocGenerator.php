 ...
 * $doc->output();
 *
 * @autor Max S. Ferreira        mxferreira@yahoo.com.br
 * @version 0.2         10.12.2005
 *
 * TO-DO
 * - add switch with page types in constructor
 * - to improve formatting style
...
class clsMsDocGenerator{
        ...
        function output($WoreName){
                ...
                header ("Content-Disposition: attachment; filename=$WoreName" );  //�����ļ����
        ...
        * @param $classesName: array with class name of any class defined in extra format file, a item for each cell item
        ...
        function prepareDefaultHeader(){
                ...
                $this->formatBuffer .= '   font-family: "����";' . "\n";
                $this->formatBuffer .= '   mso-fareast-font-family: "����";}' . "\n";
