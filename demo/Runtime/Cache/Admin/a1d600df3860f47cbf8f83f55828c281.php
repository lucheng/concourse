...
<!-- Content (Right Column) -->
		<div id="content" class="box">
            ...
            <p class="msg info">提示：</p>
             <form action="<?php echo U('Members/memberslist');?>" method="get" >
            ...
            <table width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr >
                    <td style="text-align:left" ><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" /> <a href="<?php echo u('Members/edit',array('id'=>$vo['id']));?>"><?php echo ($vo['id']); ?></a></td>
				    <td style="text-align:left" id="classname" ><?php echo ($vo["firstname"]); ?>&nbsp;<?php echo ($vo["lastname"]); ?></td>
				    <td style="text-align:left" ><?php echo ($vo['email']); ?></td>
                    <td style="text-align:left" ><?php echo toDate($vo["createdate"],"Y-m-d H:i:s");?></td>
                    <td style="text-align:left" ><?php echo toDate($vo["lastlogindate"],"Y-m-d H:i:s");?></td>
                    <td style="text-align:left" ><?php echo ($vo["lastloginip"]); ?></td>
                    <td style="text-align:center" ><a href="<?php echo u('Members/edit',array('id'=>$vo['id']));?>"><img src="../Public/admin/pro_edit.jpg" title="编辑" /></a>&nbsp;&nbsp;<a name="del_<?php echo ($vo["id"]); ?>"  href="<?php echo u('Members/Delete',array('id'=>$vo['id']));?>" ><img src="../Public/admin/out_del.jpg"title="删除" /></a></td>
