...
<!-- Content (Right Column) -->
		<div id="content" class="box">
            ...
            <form action="<?php echo U('Article/insert');?>" name="myform" method="post" enctype="multipart/form-data">
            <table class="nostyle">
                      <tr>
					...
					<tr>
						<td style="width:120px;">副标题(选填):</td>
						<td><input type="text" size="60" name="title2" class="input-text" value="" /></td>
					</tr>
                    <tr>
                    ...
                    <tr>
						...
						<td width="550">
						<!-- 编辑器调用开始 --><script type="text/javascript" src="__ROOT__/Public/Js/FCKeditor/fckeditor.js"></script><textarea id="content" name="content"></textarea><script type="text/javascript"> var oFCKeditor = new FCKeditor( "content","100%","400x" ) ; oFCKeditor.BasePath = "__ROOT__/Public/Js/FCKeditor/" ; oFCKeditor.ReplaceTextarea() ;function resetEditor(){setContents("content",document.getElementById("content").value)}; function saveEditor(){document.getElementById("content").value = getContents("content");} function InsertHTML(html){ var oEditor = FCKeditorAPI.GetInstance("content") ;if (oEditor.EditMode == FCK_EDITMODE_WYSIWYG ){oEditor.InsertHtml(html) ;}else	alert( "FCK必须处于WYSIWYG模式!" ) ;}</script> <!-- 编辑器调用结束 -->
