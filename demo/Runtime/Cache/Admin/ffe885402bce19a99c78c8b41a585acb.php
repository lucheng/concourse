...
function delall(){
	...
	if(!id){
		...
		$.post("<?php echo U('Members/delete');?>","id="+id);
...
<!-- Content (Right Column) -->
		<div id="content" class="box">
            ...
            <form action="<?php echo U('Members/groupsadd');?>" method="post" >
            <fieldset>
				<legend>添加会员等级</legend>
				<table class="nostyle">
					<tbody>
					<tr>
						<td style="width: 70px;">名称:</td>
						<td><input type="text" class="input-text" name="name" size="40"></td>
					</tr>
					<tr>
						<td style="width: 70px;">最小积分:</td>
						<td><input type="text" class="input-text" name="minpoints" size="40"></td>
					</tr>
					<tr>
						<td style="width: 70px;">最大积分:</td>
						<td><input type="text" class="input-text" name="maxpoints" size="40"></td>
					</tr>
					<tr>
						<td style="width: 70px;">折扣率:</td>
						<td><input type="text" class="input-text" name="discount" size="10"></td>
					</tr>
					
					<tr>
						<td class="t-right" colspan="2"><input type="submit" value="添加" class="input-submit"></td>
					</tr>
				</tbody></table>
			</fieldset> 
			</form>
            <table width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr >
                    <td style="text-align:left" ><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" /> <?php echo ($vo['id']); ?></td>
				    <td style="text-align:left" id="classname" ><?php echo ($vo["name"]); ?></td>
				    <td style="text-align:left" ><?php echo ($vo['minpoints']); ?></td>
                    <td style="text-align:left" ><?php echo ($vo['maxpoints']); ?></td>
                    <td style="text-align:left" ><?php echo ($vo['discount']); ?></td>
                    <td style="text-align:center" ><a href="<?php echo u('Members/groupsedit',array('id'=>$vo['id']));?>">编辑</a>&nbsp;|&nbsp;<a name="del_<?php echo ($vo["id"]); ?>"  href="<?php echo u('Members/groupsdel',array('id'=>$vo['id']));?>" >移除</a></td>
