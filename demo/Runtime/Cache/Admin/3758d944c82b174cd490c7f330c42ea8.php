...
function status(id,_this){
	$.post("<?php echo U('Down_cate/status');?>",'id='+id,function(data){
...
function delall(){
	...
	if(!id){
		...
		$.post("<?php echo U('Down_cate/delete');?>","id="+id);
...
<!-- Content (Right Column) -->
		<div id="content" class="box">
            ...
            <p id="btn-create" class="box">
              <a href="<?php echo U('Down_cate/add');?>">添加新类别</a> <a href="javascript:delall();">批量下载</a>
            </p>
            ...
            <table width="100%">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr >
                    ...
                    <td style="text-align:center" ><a href="<?php echo U('Down_cate/edit',array('id'=>$vo['id']));?>"><img src="../Public/admin/pro_edit.jpg" /></a>&nbsp;<a name="del_<?php echo ($vo["id"]); ?>"  href="<?php echo U('Down_cate/delete',array('id'=>$vo['id']));?>" ><img src="../Public/admin/out_del.jpg" /></a></td>
