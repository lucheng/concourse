...
<div class="col2">
        <div class="list1">
          <div class="list1_title"><a href="/">Home</a> > <?php echo ($disp_text); ?></a>
	</volist></div>
  ...
  <tr>
    <td>Displaying <?php echo ($startRow); ?> to <?php echo ($endRow); ?> (of <?php echo ($totalRows); ?> review)</td>
 ...
 <div class="gride">
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="g_pro">
              <div class="g_pro_img"><a href="<?php echo build_url($vo,'pro_url');?>" altimg="<?php echo build_url($vo,'altimg');?>" title="<?php echo build_url($vo,'pro_name');?>" ><img src="<?php echo build_url($vo,'pro_smallimage');?>" width="160" height="160" alt="<?php echo build_url($vo,'pro_name');?>" border="0" /></a><br/>
              <img src='../Public/admin/stars_<?php echo (($vo["star"])?($vo["star"]):"5"); ?>_small.gif' /></div>
              <div class="g_pro_name"><a href="<?php echo build_url($vo,'pro_url');?>"><h1><?php echo build_url($vo,'pro_name');?></h1></a><span>Product ID:<?php echo ($vo["id"]); ?></span><br />
              <strong>Title:</strong><?php echo ($vo["title"]); ?><br/>
              <strong>Content:</strong><?php echo ($vo["content"]); ?></div>
              <div class="g_pro_pri">
               <?php echo build_url($vo,'pro_price');?>
