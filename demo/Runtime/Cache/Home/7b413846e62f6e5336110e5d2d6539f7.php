...
//]]>
 ...
 <div class="col2">
        <div class="list1">
          <div class="list1_title"><a href="/">Home</a> > FAQs</div>
          <div class="list2_content">
            <div class="faq">
              <div class="faq_content">
                <ul>
                 <?php if(is_array($faq)): $i = 0; $__LIST__ = $faq;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><?php echo ($i); ?>.<a href="__APP__/article-<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
              </div>
              <div class="faq1">
              <?php echo ($content); ?>
                <br /><a href="#"><img src="../Public/images/button_back.gif" alt="" border="0" /></a>
              </div>
