...
//]]>
 ...
 <?php echo GetSettValue('hottitle');?>
 </div>
        <div class="ad">
          <div class="midd_ad">
...
var bcastr_config='0xffffff|2|0x0066ff|60|0xffffff|0x0066ff|0x000033|8|2|1|_blank';

document.write('<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="'+ swf_width +'" height="'+ swf_height +'">');
document.write('<param name="movie" value="../Public/flash/bcastr3.swf"><param name="quality" value="high">');
...
document.write('</object>'); 
          ...
          <div class="right_ad">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="padding-bottom:5px;"><a href="<?php echo U('Pro/hot');?>"><img src="../Public/images/banner4.jpg" alt="" border="0" /></a></td>
  </tr>
  <tr>
    <td style="padding-bottom:5px;"><a href="<?php echo U('Pro/reviews');?>"><img src="../Public/images/banner5.jpg" alt="" border="0" /></a></td>
  </tr>
  <tr>
    <td><a href="__APP__/FAQs/"><img src="../Public/images/banner6.jpg" alt="" border="0" /></a></td>
  </tr>
</table>
          </div>
        </div>
        <div class="list">
          ...
          <div class="list_content">
            <div class="left_list">
              <a href="###" class="prev"><img src="../Public/images/left_list.gif" alt="" border="0" /></a>
            </div>
            
            <div class="midd_list carousel">
            <ul>
            <?php if(is_array($SpeProducts)): $i = 0; $__LIST__ = $SpeProducts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><div class="pro">
                <div class="pro_img"><a href="<?php echo build_url($vo,'pro_url');?>" altimg="<?php echo build_url($vo,'altimg');?>" title="<?php echo build_url($vo,'pro_name');?>" ><img src="<?php echo build_url($vo,'pro_smallimage');?>" width="129"  height="109" alt="<?php echo build_url($vo,'pro_name');?>"  border="0" /></a></div>
                <div class="pro_name"><a href="<?php echo build_url($vo,'pro_url');?>"><?php echo build_url($vo,'pro_name');?></a></div>
                <div class="pro_pri"><?php echo build_url($vo,'pro_price');?></div>
              </div></li><?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
            </div>
            <div class="right_list">
              <a href="###" class="next"><img src="../Public/images/right_list.gif" alt="" border="0" /></a>
            </div>
          </div>
        </div>
        <div class="list1">
          <div class="list1_title">Featured Products</div>
          <div class="list1_content">
             <?php if(is_array($FeaturedProducts)): $i = 0; $__LIST__ = $FeaturedProducts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="pro">
                <div class="pro_img"><a href="<?php echo build_url($vo,'pro_url');?>" altimg="<?php echo build_url($vo,'altimg');?>" title="<?php echo build_url($vo,'pro_name');?>" ><img src="<?php echo build_url($vo,'pro_smallimage');?>" width="129" height="109" alt="<?php echo build_url($vo,'pro_name');?>"  border="0"/></a></div>
                <div class="pro_name"><a href="<?php echo build_url($vo,'pro_url');?>"><?php echo build_url($vo,'pro_name');?></a></div>
                <div class="pro_pri"><?php echo build_url($vo,'pro_price');?></div>
              </div><?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<div id="cate_remark">
   <div class="cate_txt" style="text-align:left"><?php echo ($recpro_remark); ?></div>
    </div>
