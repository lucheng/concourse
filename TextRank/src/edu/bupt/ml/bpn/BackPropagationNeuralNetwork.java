...
public class BackPropagationNeuralNetwork {
     ...
     */
    public BackPropagationNeuralNetwork(int input, int hidden, int output) {
        inputCount = input;
        hiddenCount = hidden;
        outputCount = output;
        build();
    ...
    public static void main(String[] args) throws Throwable {
        //创建一个 反向传输神经网络
        BackPropagationNeuralNetwork jbpn = new BackPropagationNeuralNetwork(2, 4, 1);
