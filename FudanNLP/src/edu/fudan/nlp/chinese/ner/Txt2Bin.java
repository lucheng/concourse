...
public class Txt2Bin {
	 ...
	 * @throws IOException
	 */
	private static void bin2txtModel(String inText,String outBin) throws IOException {
		ObjectInputStream in = new ObjectInputStream(new BufferedInputStream (new GZIPInputStream (new FileInputStream(outBin))));
		String rules = "";
		String _ruleunit = in.readLine();
		while (_ruleunit!=null)
		{
			System.out.println(_ruleunit);
	...
	public static void main(String[] args) throws Exception{
		bin2txtModel("D:/TimeExp-Rules.txt", "models/TimeExp.gz");
//		text2binModel("D:/TimeExp-Rules.txt", "models/TimeExp.gz");
	}
}
