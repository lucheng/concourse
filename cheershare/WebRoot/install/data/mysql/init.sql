...
create index [{shopxx_table_prefix}area]_grade on [{shopxx_table_prefix}area](grade);
create index [{shopxx_table_prefix}area]_order_list on [{shopxx_table_prefix}area](order_list);
create index [{shopxx_table_prefix}article]_create_date on [{shopxx_table_prefix}article](create_date);
create index [{shopxx_table_prefix}article]_hits on [{shopxx_table_prefix}article](hits);
create index [{shopxx_table_prefix}article_category]_grade on [{shopxx_table_prefix}article_category](grade);
create index [{shopxx_table_prefix}article_category]_order_list on [{shopxx_table_prefix}article_category](order_list);
create index [{shopxx_table_prefix}brand]_order_list on [{shopxx_table_prefix}brand](order_list);
create index [{shopxx_table_prefix}comment]_create_date on [{shopxx_table_prefix}comment](create_date);
create index [{shopxx_table_prefix}delivery_corp]_order_list on [{shopxx_table_prefix}delivery_corp](order_list);
create index [{shopxx_table_prefix}delivery_type]_order_list on [{shopxx_table_prefix}delivery_type](order_list);
create index [{shopxx_table_prefix}deposit]_create_date on [{shopxx_table_prefix}deposit](create_date);
create index [{shopxx_table_prefix}friend_link]_order_list on [{shopxx_table_prefix}friend_link](order_list);
create index [{shopxx_table_prefix}goods]_create_date on [{shopxx_table_prefix}goods](create_date);
create index [{shopxx_table_prefix}goods]_name on [{shopxx_table_prefix}goods](name);
create index [{shopxx_table_prefix}goods]_price on [{shopxx_table_prefix}goods](price);
create index [{shopxx_table_prefix}goods_attribute]_order_list on [{shopxx_table_prefix}goods_attribute](order_list);
create index [{shopxx_table_prefix}goods_category]_grade on [{shopxx_table_prefix}goods_category](grade);
create index [{shopxx_table_prefix}goods_category]_order_list on [{shopxx_table_prefix}goods_category](order_list);
create index [{shopxx_table_prefix}goods_notify]_create_date on [{shopxx_table_prefix}goods_notify](create_date);
create index [{shopxx_table_prefix}instant_messaging]_order_list on [{shopxx_table_prefix}instant_messaging](order_list);
create index [{shopxx_table_prefix}leave_message]_create_date on [{shopxx_table_prefix}leave_message](create_date);
create index [{shopxx_table_prefix}log]_create_date on [{shopxx_table_prefix}log](create_date);
create index [{shopxx_table_prefix}member_attribute]_order_list on [{shopxx_table_prefix}member_attribute](order_list);
create index [{shopxx_table_prefix}message]_create_date on [{shopxx_table_prefix}message](create_date);
create index [{shopxx_table_prefix}navigation]_order_list on [{shopxx_table_prefix}navigation](order_list);
create index [{shopxx_table_prefix}order]_create_date on [{shopxx_table_prefix}order](create_date);
create index [{shopxx_table_prefix}order_log]_create_date on [{shopxx_table_prefix}order_log](create_date);
create index [{shopxx_table_prefix}payment]_create_date on [{shopxx_table_prefix}payment](create_date);
create index [{shopxx_table_prefix}payment_config]_order_list on [{shopxx_table_prefix}payment_config](order_list);
create index [{shopxx_table_prefix}refund]_create_date on [{shopxx_table_prefix}refund](create_date);
create index [{shopxx_table_prefix}reship]_create_date on [{shopxx_table_prefix}reship](create_date);
create index [{shopxx_table_prefix}shipping]_create_date on [{shopxx_table_prefix}shipping](create_date);
create index [{shopxx_table_prefix}specification]_order_list on [{shopxx_table_prefix}specification](order_list);
