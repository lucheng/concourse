...
<body class="list">
	...
	<div class="body">
		<form id="listForm" action="<%=path %>/product/list" method="post">
			<div class="listBar">
				<input type="button" class="formButton" onclick="location.href='<%=path %>/product/add'" value="添加品牌" hidefocus="">
				&nbsp;&nbsp;
				<label>查找: </label>
			...
			<table id="listTable" class="listTable">
				<tbody>
					<tr>
						...
						<th>
							<a href="#" class="sort" name="url" hidefocus="">商家</a>
						</th>
						<th>
					...
					<tr>
						...
						<td>
							<a href="${entry.shop.url}" target="_blank">${entry.shop.title}</a>
						</td>
						<td>
								-
						</td>
