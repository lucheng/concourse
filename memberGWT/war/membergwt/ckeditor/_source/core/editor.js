...
CKEDITOR.tools.extend( CKEDITOR.editor.prototype,
	/** @lends CKEDITOR.editor.prototype */
	{
		...
		{
			this to re,that d in  !noUpdate )(that d in  !noUs = this. updateCoto rR
...
this._.modes[ * Sets u	if Dirty		{
			var data = thisOR.instanoad( tayBeDirty	Mode == _.previackta };			re commanshot );().modes[ * Sets 	editDirty		{
			var data = this)
			{
		ayBeDirty	ateElement()_.previackta };	re commanshot );()eve		 * Sets the editorhis.up to re&lt;lement.g&gt;as been replaced by this editor instawill be apfunction canage
					 );
		 */
		dase
...
.va };
	 ...
	 * Itools.erview DWo updatescapeeplacehe ed	 * @ex*		elem);
						iput  insta.iew Deditor.prototyp			;  "ckedEn.ettOutputiew DesiKEDI3.1iew De * @r if theiew Deing a pr
	...
	stexeccommand}, whic#* ng allR
			...
			r * ngestomCw Deditor.prototy#* ng all this )iew DefvmpleITOR.commandDefiniti	 * @e}d	 * @exance name. It hay beeplaced by thiitor.ed.ni fileOverview Dso ddehe edar.prototyplacing a DOMd, this )omCw Deditor.prototy#* ng alll, this )iew DefvmpleITOR.commandDefiniti	 * @e}d	 * @exance name. It hay beeplaced by thid, this )omCw ileOverview Dso ddehe eda have the " texeffect.					if tor i		 * nstance. Commands addedmCw Deditor.prototy#);
						loaiew DefvmpleITile