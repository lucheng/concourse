package com.happiness.client.util;
   ...
   class Entities {
       ...
       public String escape(String str) {
         StringBuffer sb = createStringWriter(str);
           try {
               this.escape(sb, str);
           } catch (Exception e) {
        ...
        * @see Writer
        */
       public void escape(StringBuffer sb, String str) throws IOException {
           int len = str.length();
           for (int i = 0; i < len; i++) {
               char c = str.charAt(i);
       ...
       public String unescape(String str){
           ...
           if (firstAmp < 0) {
             ...
             StringBuffer stringWriter = createStringWriter(str);
               try {
        ...
        */
       private StringBuffer createStringWriter(String str) {
           return new StringBuffer((int) (str.length() + (str.length() * 0.1)));
       }
        ...
        * @see Writer
        */
       public void unescape(StringBuffer sb, String str) throws IOException {
           int firstAmp = str.indexOf('&');
           if (firstAmp < 0) {
               sb.append(str);
               return;
        ...
        *             methods.
        */
       private void doUnescape(StringBuffer sb, String str, int firstAmp) throws IOException {
