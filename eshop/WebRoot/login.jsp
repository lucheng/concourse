...
<body class="login">
	...
	<div class="blank"></div>
	<div class="body">
		<form id="loginForm" action="http://demo.shopxx.net/admin/login/check" method="post">
            <table class="loginTable">
                ...
                <tr>
                    ...
                    <td>
                    	<input type="text" id="captcha" name="j_captcha" class="formText captcha">
                   		<img id="captchaImage" class="captchaImage" src="<%=path %>/images/captcha.jpeg" alt="换一张">
                    </td>
                </tr>
                <tr>
                	<td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="button" class="homeButton" value="" onclick="window.open(&#39;/&#39;)" hidefocus=""><input type="submit" class="submitButton" value="登 录" hidefocus="">
                    </td>
                </tr>
            </tbody></table>
            <div class="powered">
