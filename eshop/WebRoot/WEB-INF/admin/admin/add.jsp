...
<body class="input admin">
	...
	<div class="body">
		<form id="validateForm" action="<%=path %>/admin/save" method="post">
			...
			<table class="inputTable tabContent" style="display: table; ">
				...
				<tr>
					...
					<td>
						<input type="text" name="admin.email" class="formText" value="">
						<label class="requireField">*</label>
					</td>
				</tr>
				<tr class="roleList">
				...
				<tr>
					...
					<td>
						<label>
							<input type="checkbox" name="admin.isAccountEnabled" value="true" id="admin_isAccountEnabled" checked="checked"><input type="hidden" id="__checkbox_admin_isAccountEnabled" name="__checkbox_admin.isAccountEnabled" value="true">启用
						</label>
					</td>
				</tr>
			</tbody></table>
