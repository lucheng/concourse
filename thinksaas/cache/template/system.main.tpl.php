...
$(document).ready(function(){
	$.getJSON("http://www.thinksaas.cn/index.php?app=group&ac=notice&callback=?", 
	function(data){
...
<h2>软件信息</h2>
<table>
<tr><td width="100">系统支持：</td><td><?php echo $TS_SOFT['info'][name];?></td></tr>
<tr><td>程序版本：</td><td><?php echo $TS_SOFT['info'][version];?></td></tr>
<tr><td>联系方式：</td><td><?php echo $TS_SOFT['info'][email];?></td></tr>
<tr><td>官方网址：</td><td><a href="<?php echo $TS_SOFT['info'][url];?>" target='_blank'><?php echo $TS_SOFT['info'][url];?></a></td></tr>
</table>
</div>
