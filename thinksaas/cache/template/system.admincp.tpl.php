...
*html .midder {top:0; height:100%; max-height:100%; width:100%; overflow:auto;position:absolute; z-index:3; border-top:100px solid #fff; border-bottom:60px solid #fff;}

.header{position:absolute;margin:0;top:0;display:block;width:100%;height:60px;background:#3A81C0;background-position:0 0; background-repeat:no-repeat;z-index:5;overflow:hidden;border-bottom:1px #3266A0 solid;}
.header .logo{float:left;padding-top:10px;}
.header .menu{float:right;overflow:hidden;padding-right:20px;padding-top:20px;}
.header .menu ul{margin:0;padding:0;overflow:hidden;}
.header .menu ul li{list-style:none;float:left;padding:5px;color:#FFFFFF;}
...
<body>
<div class="header">
<div class="logo"><a href="index.php?app=system"><img src="app/<?php echo $app;?>/skins/<?php echo $skin;?>/logo.gif" alt="ThinkSAAS社区管理" /></a></div>
<div class="menu">
<ul>
<li>欢迎您，<?php echo $TS_USER['admin'][username];?></li>
...
<div class="footer">
<p>Copyright (C) <?php echo $TS_SOFT['info'][year];?> <a href="<?php echo $TS_SOFT['info'][url];?>"><?php echo $TS_SOFT['info'][name];?></a> <?php echo $TS_SOFT['info'][version];?></p>
</div>
