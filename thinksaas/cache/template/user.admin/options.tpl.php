...
<tr><td>用户注册:</td><td><input <?php if($strOption['isregister']=='0') { ?>checked="select"<?php } ?> name="isregister" type="radio" value="0" />自由注册 <input <?php if($strOption['isregister']=='1') { ?>checked="select"<?php } ?> name="isregister" type="radio" value="1" />邀请注册 <input <?php if($strOption['isregister']=='2') { ?>checked="select"<?php } ?> name="isregister" type="radio" value="2" />关闭注册</td></tr>
