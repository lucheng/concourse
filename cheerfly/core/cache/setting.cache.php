...
function bindCacheSetting()
{
	...
	$settings['site_title'] .= ' - '.'淘宝贝、晒搭配，掌握商城正品打折促销信息，尽享网购乐趣。';
//	$settings['footer_html'] .= '<'.'p'.'>'.'<'.'a'.' '.'h'.'r'.'e'.'f'.'='.'"'.'h'.'t'.'t'.'p'.':'.'/'.'/'.'w'.'w'.'w'.'.'.'f'.'a'.'n'.'w'.'e'.'.'.'c'.'o'.'m'.'"'.' '.'t'.'a'.'r'.'g'.'e'.'t'.'='.'"'.'_'.'b'.'l'.'a'.'n'.'k'.'"'.'>'.'方'.'维'.'购'.'物'.'分'.'享'.'系'.'统'.'<'.'/'.'a'.'>'.'<'.'/'.'p'.'>';
