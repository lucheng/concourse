...
require_once FANWE_ROOT.'sdks/renren/class/config.inc.php';
...
$_FANWE['login_oauth']['renren'] = $login_oauth;
require_once FANWE_ROOT."core/class/user/renren.class.php";
$tqq = new RenrenUser();

require_once FANWE_ROOT."sdks/renren/renren.php";
if(!RenrenOAth::getAccessToken($code)){
	exit;
}
