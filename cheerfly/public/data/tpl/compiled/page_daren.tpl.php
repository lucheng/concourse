...
0
|| checkTplRefresh('./tpl/pink2/page/daren.htm', './tpl/pink2/inc/header.htm', 1334028654, './data/tpl/compiled/page_daren.tpl.php', './tpl/pink2', 'page/daren')
|| checkTplRefresh('./tpl/pink2/page/daren.htm', './tpl/pink2/inc/pages.htm', 1334028654, './data/tpl/compiled/page_daren.tpl.php', './tpl/pink2', 'page/daren')
|| checkTplRefresh('./tpl/pink2/page/daren.htm', './tpl/pink2/inc/footer.htm', 1334028654, './data/tpl/compiled/page_daren.tpl.php', './tpl/pink2', 'page/daren')
;?>
<?php 
...
$g_r_cate = &$_FANWE['cache']['goods_category']['all'][$g_r_cate];
 ?>
<li><a href="<?php echo FU('club/index',array()); ?>"<? if(MODULE_NAME == 'Club') { ?> class="c"<? } ?>>主题</a></li>
<li><a href="<?php echo FU('magazine',array()); ?>"<? if(MODULE_NAME == 'Magazine') { ?> class="c"<? } ?>>杂志社</a></li>
<!--
...
<li><a class="<? if(MODULE_NAME == 'Ask') { ?> c<? } ?>" href="<?php echo FU('ask/index',array()); ?>">问答</a></li>
<!--
<li><a href="<?php echo FU('magazine',array()); ?>"<? if(MODULE_NAME == 'Magazine') { ?> class="c"<? } ?>>杂志社</a></li>
-->
<li><a href="<?php echo FU('daren/index',array()); ?>"<? if(MODULE_NAME == 'Daren') { ?> class="c"<? } ?>>达人</a></li>
<? if($_FANWE['setting']['second_status'] == 1) { ?>
<li><a href="<?php echo FU('second',array()); ?>"<? if(MODULE_NAME == 'Second') { ?> class="c"<? } ?>>无限衣橱</a></li>
<? } ?>
<li><a href="<?php echo FU('shop',array()); ?>"<? if(MODULE_NAME == 'Shop') { ?> class="c"<? } ?>>当红好店</a></li>
