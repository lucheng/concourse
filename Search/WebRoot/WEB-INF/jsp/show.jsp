...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<head>
		...
		<link href="css/editPage.css" type="text/css" rel="stylesheet">
    ...
    <div class="basicInfoWrapper">
    	<div class="basicInfo" id="result-basicInfo">
    		<div class="basicInfoHeader"></div>
    		<div class="basicInfoContent">
    			<div class="basicInfoImage">
    				<a href="/view.aspx?id=5753483">
    					<img width="65px" height="65px" src="./portrait.aspx?id=5753483&amp;type=1" title="http://research.microsoft.com/en-us/people/leizhang/img_4730-portrait.jpg" class="user-profile-link">
    				</a>
    			</div>
    			<div class="basicInfoBasicContent">
    				<div class="basicInfoBasicContent_Name">
    					<a href="view.aspx?id=5753483">张磊</a>
    				</div>
    				<div class="basicInfoBasicContent_Label">
	    				<div class="twoLineDescPerLineNotShown">机构:微软亚洲研究院</div>
	    				<div class="twoLineDescPerLineNotShown">标签:博士</div>
	    				<br>
    				</div>
    			</div>
    		</div>
