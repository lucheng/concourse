...
import edu.bupt.spring.config.SystemConfig.CurrencyType;
import edu.bupt.spring.config.SystemConfig.PointType;
import edu.bupt.spring.config.SystemConfig.RoundType;
import edu.bupt.spring.config.SystemConfig.StoreFreezeTime;
import edu.bupt.spring.config.SystemConfig.WatermarkPosition;
