...
copyright © 2011~2012 毫米网 版权所有
<!--<a class="softname" href="<?php echo $TS_SOFT['info'][url];?>"><?php echo $TS_SOFT['info'][name];?></a> 
<?php echo $TS_SOFT['info'][version];?> <?php echo $TS_SOFT['info'][year];?> 
-->
<?php echo $TS_SITE['base'][site_icp];?>
<br />
<span style="font-size:0.83em;">Processed in <?php echo $runTime;?> second(s)</span></div>
